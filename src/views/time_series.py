...
from src.views.common import pretty_name, render_parameter_and_subset, render_stats_toolbar
...
# Short labels for the Temperature band-chart trend-line toggle, and
# which of the other two 2m series bound the shaded band (low, high) for
# each choice. temperature_air_min_2m/_max_2m always occupy the low/high
# slot no matter what -- min <= mean <= max always holds in DWD's
# climate_summary -- only temperature_air_mean_2m ever moves between
# being the line and being a band edge.
